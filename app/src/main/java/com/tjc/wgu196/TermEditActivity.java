...
import static com.tjc.wgu196.utilities.Constants.TERM_ID_KEY;
        ...
        if(mViewModel.mLiveTerm.getValue() != null) {
            ...
            if(courseData != null && courseData.size() != 0) {
                ...
                builder.setMessage("Are you sure you want to delete term '" + termTitle + "'?" +
                        "\nCourses are still assigned to the term. You will not delete the courses but " +
                        "they will not be assigned to any terms if you delete this term.\nDelete term anyway?");
